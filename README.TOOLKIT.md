...
* movie-crud-app:GetItemsFunction (nodejs18.x)
* API movie-crud-app:GetItemsFunction (nodejs18.x)
* movie-crud-app:GetItemKeySchemaFunction (nodejs18.x)
* API movie-crud-app:GetItemKeySchemaFunction (nodejs18.x)
* movie-crud-app:PutItemFunction (nodejs18.x)
* API movie-crud-app:PutItemFunction (nodejs18.x)
* movie-crud-app:DeleteItemFunction (nodejs18.x)
* API movie-crud-app:DeleteItemFunction (nodejs18.x)
